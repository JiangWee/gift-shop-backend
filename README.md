...
基于 Node.js + Express 的混合架构后端系统，用户认证和订单管理使用 MySQL 数据库。
这其中后端部署在fly.io，数据库托管在PlanetScale。
...
gift-shop-backend/
├── api/index.js              # ✅ Vercel服务器入口（文档1）
├── config/
│   ├── database.js          # ✅ MySQL数据库配置（文档2）
│   └── google-sheets.js     # ✅ Google Sheets配置（文档3）
├── controllers/
│   ├── authController.js    # ✅ 用户认证逻辑（文档4）
│   └── orderController.js   # ✅ 订单管理逻辑（文档5）
├── middleware/
│   ├── authMiddleware.js    # ✅ JWT认证中间件（文档7）
│   └── validationMiddleware.js # ✅ 数据验证（文档8）
├── models/
│   └── userModel.js         # ✅ 用户数据模型（文档9）
├── routes/
│   ├── authRoutes.js        # ✅ 认证路由（文档10）
│   └── orderRoutes.js       # ✅ 订单路由（文档11）
├── utils/
│   ├── authUtils.js         # ✅ 认证工具（文档13）
│   └── googleSheetsUtils.js # ✅ Google Sheets工具（文档14）
├── database/schema.sql      # ✅ 数据库表结构（文档6）
├── scripts/test-api.js      # ✅ API测试脚本（文档12）
├── app.js                   # ✅ Express应用配置（文档15）
├── server.js                # ✅ 本地服务器入口（文档18）
├── package.json             # ✅ 项目配置（文档16）
├── vercel.json              # ✅ Vercel部署配置（文档19）
└── README.md                # ✅ 项目说明（文档17）
